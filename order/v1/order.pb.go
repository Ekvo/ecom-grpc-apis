...
type Order struct {
	...
	Quantiy       int32                  `protobuf:"varint,4,opt,name=quantiy,proto3" json:"quantiy,omitempty"`
...
const file_order_v1_order_proto_rawDesc = "" +
	...
	"\aquantiy\x18\x04 \x01(\x05R\aquantiy\x12\x1d\n" +
	"\n" +
	...
	"\bGetOrder\x12\x19.order.v1.GetOrderRequest\x1a\x1a.order.v1.GetOrderResponseB)Z'github.com/Ekvo/ecom-grpc-apis/order/v1b\x06proto3"
