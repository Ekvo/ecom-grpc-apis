...
const file_user_v1_user_proto_rawDesc = "" +
	...
	"\x02Me\x12\x12.user.v1.MeRequest\x1a\x13.user.v1.MeResponseB(Z&github.com/Ekvo/ecom-grpc-apic/user/v1b\x06proto3"
...
var file_user_v1_user_proto_depIdxs = []int32{
	...
	1, // 1: user.v1.UserServices.Register:input_type -> user.v1.RegisterRequest
	3, // 2: user.v1.UserServices.Login:input_type -> user.v1.LoginRequest
	5, // 3: user.v1.UserServices.Me:input_type -> user.v1.MeRequest
	2, // 4: user.v1.UserServices.Register:output_type -> user.v1.RegisterResponse
	4, // 5: user.v1.UserServices.Login:output_type -> user.v1.LoginResponse
	6, // 6: user.v1.UserServices.Me:output_type -> user.v1.MeResponse
